...
#define _SMF_PARENT(_parent) .parent = _parent,
#else
#define _SMF_PARENT(_parent)
#endif

#if CONFIG_SMF_INITIAL_TRANSITION
// smf.h

#define _SMF_INITIAL(_initial) .initial = _initial,
#else
#define _SMF_INITIAL(_initial)
#endif
